...
// src/tarifni-semafor-card.ts
var TarifniSemaforCard = class extends r4 {
  constructor() {
    super(...arguments);
  ...
  _getEntityAttribute(entityId, attr) {
    return entityId && this.hass?.states?.[entityId]?.attributes?.[attr];
  }
  _getCurrentBlockId(entityId) {
...
__decorateClass([
  n4({ attribute: false })
], TarifniSemaforCard.prototype, "hass", 2);
__decorateClass([
  r6()
], TarifniSemaforCard.prototype, "_config", 2);
__decorateClass([
  r6()
], TarifniSemaforCard.prototype, "_animatedProgress", 2);
TarifniSemaforCard = __decorateClass([
  t3("tarifni-semafor-card")
], TarifniSemaforCard);
